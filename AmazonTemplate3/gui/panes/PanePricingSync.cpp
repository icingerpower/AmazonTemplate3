...
#include "PanePricingSync.h"
#include "ui_PanePricingSync.h"
...
PanePricingSync::PanePricingSync(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::PanePricingSync)
{
    ui->setupUi(this);
...
PanePricingSync::~PanePricingSync()
{
    delete ui;
}

void PanePricingSync::setAvailableClis(const QList<AbstractCli *> &clis)
{
...
void PanePricingSync::showEvent(QShowEvent *event)
{
...
void PanePricingSync::hideEvent(QHideEvent *event)
{
...
QCoro::Task<void> PanePricingSync::_onRefreshRate()
{
...
QCoro::Task<void> PanePricingSync::_onRetrieve()
{
...
QCoro::Task<void> PanePricingSync::_onUpdate()
{
